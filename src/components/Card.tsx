...
const Card: FC<CardProps> = ({ imgSrc, title }) => {
  return (
    <div 
      ...
      max-w-[448px] rounded-2x overflow-hidden transition-all duration-700 ease-in-out"
      >
        <img 
          src={imgSrc}
          alt=""
        ...
        <p className="text-textPrimary absolute -top-12 left-1/2 -transalte-x-1/2 opacity-0 group-hover:top-0.5 group-hover:opacity-100
